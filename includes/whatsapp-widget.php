<div class="wa-widget" id="wa-widget">
  <div class="wa-widget-panel" role="dialog" aria-label="Contact options">
    ...
    <div class="wa-widget-body" style="padding:12px;display:flex;flex-direction:column;gap:8px;background:#FFFFFF;">
      ...
      <!-- ENQUIRY MAIL -->
      <a href="mailto:mail@inboxwa.com" class="wa-widget-action" style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:12px;text-decoration:none;color:#0F172A;font-weight:600;font-size:0.88rem;background:#F8FAFC;border:1px solid #E2E8F0;transition:all 0.2s;">
      ...
      <!-- SUPPORT MAIL -->
      <a href="mailto:support@inboxwa.com" class="wa-widget-action" style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:12px;text-decoration:none;color:#0F172A;font-weight:600;font-size:0.88rem;background:#F8FAFC;border:1px solid #E2E8F0;transition:all 0.2s;">
