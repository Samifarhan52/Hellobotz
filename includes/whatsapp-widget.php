<div class="wa-widget" id="wa-widget">
  <div class="wa-widget-panel" role="dialog" aria-label="Contact options">
    <div class="wa-widget-header" style="background:linear-gradient(135deg,#8B5CF6 0%,#6366F1 50%,#06B6D4 100%);color:#fff;padding:16px 18px;border-radius:18px 18px 0 0;display:flex;align-items:center;gap:12px;">
      ...
      <div>
        <h4 style="margin:0;font-size:1rem;font-weight:800;color:#fff;">HelloBotz AI</h4>
    ...
    <div class="wa-widget-body" style="padding:12px;display:flex;flex-direction:column;gap:8px;background:#FFFFFF;">
      ...
      <!-- CALL NOW -->
      <a href="tel:+918050854445" class="wa-widget-action" style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:12px;text-decoration:none;color:#0F172A;font-weight:600;font-size:0.88rem;background:#F8FAFC;border:1px solid #E2E8F0;transition:all 0.2s;">
        ...
        Call Now (+91 8050854445)
      </a>

      <!-- ENQUIRY MAIL -->
      <a href="mailto:mail@hellobotz.com" class="wa-widget-action" style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:12px;text-decoration:none;color:#0F172A;font-weight:600;font-size:0.88rem;background:#F8FAFC;border:1px solid #E2E8F0;transition:all 0.2s;">
        ...
        Enquiry (mail@hellobotz.com)
      </a>

      <!-- SUPPORT MAIL -->
      <a href="mailto:support@hellobotz.com" class="wa-widget-action" style="display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:12px;text-decoration:none;color:#0F172A;font-weight:600;font-size:0.88rem;background:#F8FAFC;border:1px solid #E2E8F0;transition:all 0.2s;">
  ...
  <!-- FLOATING BOT LAUNCHER BUTTON WITH HELLOBOTZ LOGO Z GRADIENT -->
