...
<section class="section section-dark" id="sim">
  <div class="container">
    ...
    <div class="ws-controls">
      ...
      <button type="button" class="btn btn-sm btn-primary ws-next" data-sim="ws-facebook-ads">Next</button>
      <button type="button" class="btn btn-sm btn-outline ws-auto" style="color:#fff;border-color:rgba(255,255,255,.35)" data-sim="ws-facebook-ads">Auto-play</button>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem;margin-top:1.25rem"><div class="card card-feature reveal"><h3>Ad context</h3><p>Campaign metadata on chat.</p></div><div class="card card-feature reveal"><h3>Bot qualify</h3><p>Budget, timeline, interest.</p></div><div class="card card-feature reveal"><h3>Routing</h3><p>Rules by campaign.</p></div><div class="card card-feature reveal"><h3>CRM</h3><p>Deals from ads.</p></div><div class="card card-feature reveal"><h3>Analytics</h3><p>Chat starts vs spend.</p></div><div class="card card-feature reveal"><h3>Compliance</h3><p>Template rules for re-engage.</p></div></div>
  </div>
</section>
...
<section class="section section-alt">
  <div class="container">
    ...
    <div class="faq-list" style="max-width:760px;margin:1.5rem auto 0"><div class="faq-item reveal"><button type="button" class="faq-question" aria-expanded="false">Lead Ads without CTWA?<svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></button><div class="faq-answer"><div class="faq-answer-inner">Yes — sync leads and start WhatsApp where permitted.</div></div></div></div>
  </div>
</section>
...
<script>
(function(){
  var steps=document.querySelectorAll('#ws-facebook-ads .ws-step');
  var i=0, timer=null;
  function show(n){
  ...
  show(0);
  document.querySelectorAll('[data-sim="ws-facebook-ads"].ws-next').forEach(function(b){b.onclick=function(){show(i+1);};});
  document.querySelectorAll('[data-sim="ws-facebook-ads"].ws-prev').forEach(function(b){b.onclick=function(){show(i-1);};});
  document.querySelectorAll('[data-sim="ws-facebook-ads"].ws-auto').forEach(function(b){
    b.onclick=function(){
