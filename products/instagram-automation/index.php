...
$pageDescription = 'Automate Instagram DMs, comments and lead capture.';
$canonicalUrl = 'https://hellobotz.com/products/Instagram-Automation/';
...
<section class="section page-hero" style="padding-top:calc(var(--nav,72px) + 3rem)">
  <div class="container">
    <div class="section-header reveal">
      ...
      <p class="lead">Automate Instagram DMs, comments and lead capture.</p>
