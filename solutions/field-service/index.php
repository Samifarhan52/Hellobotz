...
<div class="features-grid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem;margin-top:1.5rem"><div class="card card-feature reveal"><h3>Job assigned</h3><p>Notify technician and customer.</p></div><div class="card card-feature reveal"><h3>ETA messages</h3><p>Reduce “where are you?” calls.</p></div><div class="card card-feature reveal"><h3>Completion</h3><p>Collect sign-off notes.</p></div><div class="card card-feature reveal"><h3>Parts alerts</h3><p>Inventory-linked pings.</p></div></div></div></section>
