...
if (!is_array($contactConfig)) {
  $contactConfig = [
    ...
    'sales_email' => 'hello@hellobotz.com',
    'support_email' => 'hello@hellobotz.com',
  ];
}
$wa = preg_replace('/\D/', '', $contactConfig['support_whatsapp'] ?? '919638911838');
$waDisplay = '+91 ' . substr($wa, 2, 5) . ' ' . substr($wa, 7);
$email = $contactConfig['sales_email'] ?? 'hello@hellobotz.com';
  ...
  <div class="container">
    ...
    <div class="ct-form-grid">
      ...
      <div class="ct-wa-card reveal">
        ...
        <p class="ct-wa-meta"><?php echo htmlspecialchars($waDisplay); ?></p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="ct-offices">
      <div class="ct-office reveal">
        ...
        <div class="ct-office-detail">
          ...
          <span><a href="<?php echo htmlspecialchars($waLink); ?>" target="_blank" rel="noopener"><?php echo htmlspecialchars($waDisplay); ?></a></span>
        </div>
        <div class="ct-office-detail">
          ...
          <span><a href="mailto:<?php echo htmlspecialchars($email); ?>"><?php echo htmlspecialchars($email); ?></a></span>
        </div>
  ...
  <div class="container">
    ...
    <div class="ct-reach">
      ...
      <div class="ct-reach-card reveal">
        ...
        <h4>WhatsApp</h4>
        <a href="<?php echo htmlspecialchars($waLink); ?>" target="_blank" rel="noopener"><?php echo htmlspecialchars($waDisplay); ?></a>
      </div>
      <div class="ct-reach-card reveal">
