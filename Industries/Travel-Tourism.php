...
<section class="section page-hero" style="padding-top:1.25rem">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h1>WhatsApp API for Travel & Tourism</h1>
      <p class="lead">Bookings, itinerary updates and guest care on WhatsApp and Instagram — for agencies, hotels and experience brands.</p>
...
<section class="section section-gradient-1"><div class="container">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1.25rem"><div class="card reveal"><h3>Last-minute changes</h3><p>Flights and hotels shift; guests need instant updates.</p></div><div class="card reveal"><h3>High touch sales</h3><p>Packages need conversation, not only forms.</p></div><div class="card reveal"><h3>Seasonal peaks</h3><p>Inbox volume spikes without extra headcount.</p></div></div>
</div></section>
