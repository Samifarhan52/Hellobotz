...
<section class="section page-hero" style="padding-top:1.25rem">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h1>WhatsApp for Hotels & Restaurants</h1>
      <p class="lead">Reservations, table booking and guest messaging with automation and a shared team inbox.</p>
...
<section class="section section-gradient-1"><div class="container">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1.25rem"><div class="card reveal"><h3>Missed reservations</h3><p>Calls drop during peak hours.</p></div><div class="card reveal"><h3>No-show tables</h3><p>Reminders are inconsistent.</p></div><div class="card reveal"><h3>Guest requests</h3><p>Scattered across personal staff phones.</p></div></div>
</div></section>
