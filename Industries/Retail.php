...
<section class="section page-hero" style="padding-top:1.25rem">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h1>WhatsApp API for Retail</h1>
      <p class="lead">Store support, loyalty nudges and campaign engagement for retail brands on WhatsApp and Instagram.</p>
...
<section class="section section-gradient-1"><div class="container">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1.25rem"><div class="card reveal"><h3>Omnichannel shoppers</h3><p>Social + store + WhatsApp are disconnected.</p></div><div class="card reveal"><h3>Campaign noise</h3><p>Blasts without reply handling waste spend.</p></div><div class="card reveal"><h3>Staff phones</h3><p>Personal numbers create compliance risk.</p></div></div>
</div></section>
