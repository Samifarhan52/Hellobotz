<?php
$basePath = '../../';
$pageTitle = 'Travel & Tourism WhatsApp & Instagram Automation | HelloBotz';
$pageDescription = 'WhatsApp Business API and Instagram automation for travel & tourism: booking, support, campaigns and shared inbox with HelloBotz.';
...
<section class="section section-dark">
  <div class="container"><div class="section-header reveal" style="text-align:center">
    <h2 style="color:#fff">Run Travel & Tourism conversations on HelloBotz</h2>
