...
<section class="section page-hero" style="padding-top:1.25rem">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h1>WhatsApp API for Healthcare</h1>
      <p class="lead">Appointments, reminders and follow-ups on Official WhatsApp API — with clear consent practices and human escalation.</p>
...
<section class="section section-gradient-1"><div class="container">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1.25rem"><div class="card reveal"><h3>No-shows</h3><p>Missed appointments waste clinical capacity.</p></div><div class="card reveal"><h3>Phone tag</h3><p>Reception queues block urgent queries.</p></div><div class="card reveal"><h3>Follow-up gaps</h3><p>Post-visit instructions rarely reach patients on time.</p></div></div>
</div></section>
