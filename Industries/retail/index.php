<?php
$basePath = '../../';
$pageTitle = 'Retail WhatsApp & Instagram Automation | HelloBotz';
$pageDescription = 'WhatsApp Business API and Instagram automation for retail: booking, support, campaigns and shared inbox with HelloBotz.';
