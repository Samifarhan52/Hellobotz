<?php
$basePath = '../../';
$pageTitle = 'Hotel & Restaurant WhatsApp & Instagram Automation | InboxWa';
$pageDescription = 'WhatsApp Business API and Instagram automation for hotel & restaurant: booking, support, campaigns and shared inbox with InboxWa.';
$canonicalUrl = 'https://inboxwa.com/industries/hotel-restaurant/';
include __DIR__ . '/../../includes/header.php';
?>
<nav class="container" style="padding-top:calc(var(--nav,72px)+1rem);font-size:.85rem;color:var(--t3)"><a href="/">Home</a> / <a href="/industries/">Industries</a> / Hotel & Restaurant</nav>
...
<section class="section section-dark">
  <div class="container"><div class="section-header reveal" style="text-align:center">
    <h2 style="color:#fff">Run Hotel & Restaurant conversations on InboxWa</h2>
