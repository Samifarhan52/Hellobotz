...
<section class="section page-hero" style="padding-top:1.25rem">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h1>WhatsApp for IT & Communication teams</h1>
      <p class="lead">Client alerts, support desks and renewal conversations for IT services, MSPs and telecom-style operations.</p>
...
<section class="section section-gradient-1"><div class="container">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1.25rem"><div class="card reveal"><h3>Alert fatigue on email</h3><p>Critical incidents missed.</p></div><div class="card reveal"><h3>Ticket context loss</h3><p>Chat and ITSM stay separate.</p></div><div class="card reveal"><h3>Renewal outreach</h3><p>Manual and easy to skip.</p></div></div>
</div></section>
