...
<section class="section page-hero" style="padding-top:1.25rem">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h1>WhatsApp API for Logistics</h1>
      <p class="lead">Shipment updates, exception handling and support automation for logistics and delivery teams.</p>
...
<section class="section section-gradient-1"><div class="container">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1.25rem"><div class="card reveal"><h3>Where is my order?</h3><p>Repetitive tracking questions.</p></div><div class="card reveal"><h3>Failed deliveries</h3><p>Reschedule coordination is manual.</p></div><div class="card reveal"><h3>B2B updates</h3><p>Clients want proactive exception alerts.</p></div></div>
</div></section>
