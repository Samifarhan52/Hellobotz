...
<section class="section page-hero" style="padding-top:1.25rem">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h1>WhatsApp API for Real Estate</h1>
      <p class="lead">Capture project enquiries, qualify budget and locality, book site visits and keep brokers aligned — all on WhatsApp.</p>
...
<section class="section section-gradient-1"><div class="container">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1.25rem"><div class="card reveal"><h3>Lead leakage</h3><p>Portal leads go cold without instant response.</p></div><div class="card reveal"><h3>Site-visit no-shows</h3><p>Confirmations and reminders are still manual.</p></div><div class="card reveal"><h3>Broker chaos</h3><p>Multiple agents messaging from personal numbers.</p></div></div>
</div></section>
