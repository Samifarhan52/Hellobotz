...
<section class="section page-hero" style="padding-top:1.25rem">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h1>WhatsApp for Government & NGO programs</h1>
      <p class="lead">Citizen and beneficiary communication at scale using Official WhatsApp API with clear templates and controlled agent access.</p>
...
<section class="section section-gradient-1"><div class="container">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1.25rem"><div class="card reveal"><h3>Reach</h3><p>Beneficiaries may not use email or apps.</p></div><div class="card reveal"><h3>Volume</h3><p>Helplines overload during campaigns.</p></div><div class="card reveal"><h3>Consistency</h3><p>Answers vary across field teams.</p></div></div>
</div></section>
