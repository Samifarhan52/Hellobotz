...
<section class="section">
  <div class="container" style="max-width:720px">
    ...
    <ul class="feature-list" style="display:flex;flex-direction:column;gap:.65rem;margin-top:1rem"><li class="feature-list-item reveal"><span class="check">✓</span><span><strong>Faster time-to-message</strong> — </span></li><li class="feature-list-item reveal"><span class="check">✓</span><span><strong>Less channel maintenance</strong> — </span></li><li class="feature-list-item reveal"><span class="check">✓</span><span><strong>Clear API contracts</strong> — </span></li></ul>
  </div>
</section>
