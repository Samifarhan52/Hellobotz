...
<section class="partner-hero">
  <div class="partner-hero__bg" aria-hidden="true">
    <img src="/assets/images/partners/reseller/hero.webp" alt="" onerror="this.style.display='none'">
  </div>
...
<section class="section">
  <div class="container" style="max-width:800px">
    ...
    <p class="lead reveal" style="text-align:center">Consultants and IT partners need a credible WhatsApp product to sell without becoming a full software vendor.</p>
  </div>
</section>
...
<section class="section section-dark" id="flow">
  <div class="container">
    ...
    <div class="ws-controls">
      ...
      <button type="button" class="btn btn-sm btn-outline ws-auto" style="color:#fff;border-color:rgba(255,255,255,.35)" data-sim="ws-p-reseller">Auto-play</button>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container" style="max-width:720px">
    ...
    <ul class="feature-list" style="display:flex;flex-direction:column;gap:.65rem;margin-top:1rem"><li class="feature-list-item reveal"><span class="check">✓</span><span><strong>Predictable recurring income</strong> — </span></li><li class="feature-list-item reveal"><span class="check">✓</span><span><strong>Faster deals with a ready product</strong> — </span></li><li class="feature-list-item reveal"><span class="check">✓</span><span><strong>Support from HelloBotz team</strong> — </span></li></ul>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:1rem">
      <div class="card reveal" style="padding:0;overflow:hidden">
        <img src="/assets/images/partners/reseller/workflow.webp" alt="Workflow" width="600" height="360" loading="lazy"
      ...
      <div class="card reveal" style="padding:0;overflow:hidden">
        <img src="/assets/images/partners/reseller/dashboard.webp" alt="Dashboard" width="600" height="360" loading="lazy"
...
<section class="section">
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;margin-top:1rem"><div class="card reveal"><h3>IT resellers</h3><p>Add messaging to stack.</p></div><div class="card reveal"><h3>CRM implementers</h3><p>WhatsApp + CRM bundles.</p></div><div class="card reveal"><h3>Regional consultants</h3><p>Local market coverage.</p></div></div>
  </div>
</section>
...
<section class="section section-alt">
  <div class="container">
    ...
    <div class="faq-list" style="max-width:760px;margin:1.5rem auto 0"><div class="faq-item reveal"><button type="button" class="faq-question" aria-expanded="false">Is there a partner fee?<svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></button><div class="faq-answer"><div class="faq-answer-inner">Commercial terms are shared during application.</div></div></div><div class="faq-item reveal"><button type="button" class="faq-question" aria-expanded="false">Can I offer services on top?<svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg></button><div class="faq-answer"><div class="faq-answer-inner">Yes — implementation and managed services are encouraged.</div></div></div></div>
  </div>
</section>

<section class="section" id="partner-form">
  <div class="container" style="max-width:560px">
    <div class="section-header reveal"><h2>Become a Reseller</h2><p class="lead">Share your details — our partner team will respond on WhatsApp or email.</p></div>
    <form class="card reveal" style="padding:1.5rem" id="partner-form-reseller" onsubmit="return false">
      <label>Name *</label>
      ...
      <button type="submit" class="btn btn-primary btn-block">Become a Reseller</button>
      <p id="pf-status-reseller" style="display:none;margin-top:.75rem;color:#15803D"></p>
    </form>
  </div>
</section>
...
<script>
(function(){
  var steps=document.querySelectorAll('#ws-p-reseller .ws-step');
  var i=0,timer=null;
  function show(n){i=Math.max(0,Math.min(n,steps.length-1));steps.forEach(function(el,idx){el.classList.toggle('on',idx<=i);});}
  show(0);
  document.querySelectorAll('[data-sim="ws-p-reseller"].ws-next').forEach(function(b){b.onclick=function(){show(i+1);};});
  document.querySelectorAll('[data-sim="ws-p-reseller"].ws-prev').forEach(function(b){b.onclick=function(){show(i-1);};});
  document.querySelectorAll('[data-sim="ws-p-reseller"].ws-auto').forEach(function(b){
