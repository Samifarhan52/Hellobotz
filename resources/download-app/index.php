<?php
$basePath = '../../';
$pageTitle = 'Download HelloBotz App';
$pageDescription = 'Manage conversations, automation and leads from the HelloBotz mobile and desktop apps.';
...
<h1>HelloBotz wherever you work</h1>
...
<div class="card res-card reveal"><h3>Desktop</h3><p>Full workspace in the browser — and desktop when available.</p><?php if ($desktop): ?><a class="btn btn-sm btn-primary" href="<?php echo htmlspecialchars($desktop); ?>">Download Desktop</a><?php else: ?><a class="btn btn-sm btn-outline" href="https://hellobotz.com/auth/login">Open Web App</a><?php endif; ?></div>
</div></div></section>
...
<a class="btn btn-primary" href="https://hellobotz.com/auth/login">Open HelloBotz</a>
</div></section>
