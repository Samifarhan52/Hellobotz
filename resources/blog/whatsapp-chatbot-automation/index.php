<?php
$basePath = '../../';
$pageTitle = 'WhatsApp Chatbot Automation for Businesses — HelloBotz Blog';
$pageDescription = 'Design flows that qualify leads and deflect FAQs.';
$canonicalUrl = 'https://hellobotz.com/resources/blog/whatsapp-chatbot-automation/';
...
<div class="blog-img-ph blog-img-ph--lg" role="img" aria-label="WhatsApp Chatbot Automation for Businesses"></div>
