<?php
$basePath = '../../';
$pageTitle = 'WhatsApp Lead Generation Automation — HelloBotz Blog';
$pageDescription = 'Click-to-WhatsApp ads to qualified chats.';
$canonicalUrl = 'https://hellobotz.com/resources/blog/lead-generation/';
include __DIR__ . '/../../includes/header.php';
?>
<link rel="stylesheet" href="/assets/css/resources.css?v=1">

<nav class="container" style="padding-top:calc(var(--nav,72px)+1rem);font-size:.85rem;color:var(--t3)"><a href="/">Home</a> / <a href="/resources/blog/">Blog</a> / WhatsApp Lead Generation Automation</nav>
...
<h1 style="margin:.75rem 0">WhatsApp Lead Generation Automation</h1>
<p style="color:var(--t3);font-size:.9rem">HelloBotz Team · 2026 · 9 min read</p>
<div class="blog-img-ph blog-img-ph--lg" role="img" aria-label="WhatsApp Lead Generation Automation"></div>
