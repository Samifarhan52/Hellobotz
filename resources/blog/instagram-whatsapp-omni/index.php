<?php
$basePath = '../../';
$pageTitle = 'Instagram + WhatsApp Omnichannel Automation — HelloBotz Blog';
$pageDescription = 'One team inbox across Meta channels.';
$canonicalUrl = 'https://hellobotz.com/resources/blog/instagram-whatsapp-omni/';
include __DIR__ . '/../../includes/header.php';
?>
<link rel="stylesheet" href="/assets/css/resources.css?v=1">

<nav class="container" style="padding-top:calc(var(--nav,72px)+1rem);font-size:.85rem;color:var(--t3)"><a href="/">Home</a> / <a href="/resources/blog/">Blog</a> / Instagram + WhatsApp Omnichannel Automat</nav>
...
<h1 style="margin:.75rem 0">Instagram + WhatsApp Omnichannel Automation</h1>
<p style="color:var(--t3);font-size:.9rem">HelloBotz Team · 2026 · 8 min read</p>
<div class="blog-img-ph blog-img-ph--lg" role="img" aria-label="Instagram + WhatsApp Omnichannel Automation"></div>
