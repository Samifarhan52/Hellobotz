...
<nav class="container" style="padding-top:calc(var(--nav,72px)+1rem);font-size:.85rem;color:var(--t3)"><a href="/">Home</a> / <a href="/resources/blog/">Blog</a> / WhatsApp API vs WATI vs AiSensy</nav>
